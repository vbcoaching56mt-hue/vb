    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md text-center border border-gray-100">
          ...
          <button onClick={() => window.location.replace('/')} className="w-full bg-gray-900 text-white font-bold py-4 rounded-2xl">
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md text-center border border-gray-100">
          ...
          <p className="text-gray-500 mb-6">Veuillez vous inscrire à nouveau.</p>
          <button onClick={() => window.location.replace('/signup')} className="w-full bg-rose-500 text-white font-bold py-4 rounded-2xl">
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <form onSubmit={handleCreate} className="space-y-4">
          ...
          <button type="submit" disabled={isSaving} className="w-full bg-gray-900 hover:bg-black text-white font-bold py-4 rounded-2xl shadow-lg transition-all disabled:opacity-50">
